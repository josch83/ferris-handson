...
class UserAccountModel(FerrisGenericModel):
    ...
    name = JSCTZIGenericColumn(
        str,
        nullable=True,
        foreign_key=False,
    )
    addresses = JSCTZIGenericColumn(
        int,
        nullable=False,
        foreign_key=True,
...
class UserAccountSession(JSCTZIGenericSession):
...
class UserAccountInterface(JSCTZIGenericInterface):
