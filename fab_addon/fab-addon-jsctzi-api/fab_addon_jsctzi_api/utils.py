...
class JSCTZIFilterConverter(BaseFilterConverter):
    """
...
class JSCTZIGenericSession(FerrisGenericSession):
...
class JSCTZIGenericColumn(FerrisGenericColumn):
    """
...
class JSCTZIGenericInterface(FerrisGenericInterface):

    filter_converter_class = JSCTZIFilterConverter
    ...
    def get_related_model(self, col_name: str) -> Type[FerrisGenericModel]:
        ...
        mod_name = (
            f"fab_addon_jsctzi_api.models.{convert_to_snake_case(class_string_name[:-5])}"
        )
