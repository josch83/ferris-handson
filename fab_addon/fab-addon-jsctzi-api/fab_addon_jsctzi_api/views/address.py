...
class JSCTZIAddressAddForm(DynamicForm):
...
class JSCTZIAddressSearchForm(DynamicForm):
...
class JSCTZIAddressView(FerrisGenericModelView):
    route_base = "/address"
    ...
    add_form = edit_form = JSCTZIAddressAddForm
    
    search_form = JSCTZIAddressSearchForm
