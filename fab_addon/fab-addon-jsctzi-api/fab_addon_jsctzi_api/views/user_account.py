...
class JSCTZIUserAccountAddForm(DynamicForm):
...
class JSCTZIUserAccountSearchForm(DynamicForm):
...
class JSCTZIUserAccountView(FerrisGenericModelView):
    ...
    add_form = edit_form = JSCTZIUserAccountAddForm
    
    search_form = JSCTZIUserAccountSearchForm
