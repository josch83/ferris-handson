...
from ..widgets import *
from ..enum_types import (role_rights_entity_enum, role_rights_role_enum, )
...
class MAGDEMORoleRightsAddForm(DynamicForm):
    ...
    entity = SelectField(
        ...
        choices=[(choice.value, choice.value) for choice in role_rights_entity_enum],
...
class MAGDEMORoleRightsSearchForm(DynamicForm):
...
class MAGDEMORoleRightsView(FerrisGenericModelView):
    ...
    add_form = edit_form = MAGDEMORoleRightsAddForm
    
    search_form = MAGDEMORoleRightsSearchForm
