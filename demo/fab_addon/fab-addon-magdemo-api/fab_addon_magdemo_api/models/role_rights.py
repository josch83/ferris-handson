...
class RoleRightsModel(FerrisGenericModel):
    ...
    can_access = MAGDEMOGenericColumn(
        bool,
        nullable=True,
        foreign_key=False,
    )
    can_create = MAGDEMOGenericColumn(
        bool,
        nullable=True,
        foreign_key=False,
    )
    can_delete = MAGDEMOGenericColumn(
        bool,
        nullable=True,
        foreign_key=False,
    )
    can_read = MAGDEMOGenericColumn(
        bool,
        nullable=True,
        foreign_key=False,
    )
    can_update = MAGDEMOGenericColumn(
        bool,
        nullable=True,
        foreign_key=False,
    )
...
class RoleRightsSession(MAGDEMOGenericSession):
...
class RoleRightsInterface(MAGDEMOGenericInterface):
