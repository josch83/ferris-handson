...
class AddressModel(FerrisGenericModel):
    ...
    email_address = MAGDEMOGenericColumn(
        str,
        nullable=False,
        foreign_key=False,
    )
    ...
    user_id = MAGDEMOGenericColumn(
        int,
        nullable=False,
        foreign_key=True,
        foreign_key_class="UserAccountModel",
...
class AddressSession(MAGDEMOGenericSession):
    def __init__(self) -> None:
        super().__init__(AddressModel, ServiceFactory(service=services_available.ADDRESS), logger)
...
class AddressInterface(MAGDEMOGenericInterface):
    def __init__(self, obj, session) -> None:
        super().__init__(obj, session, ServiceFactory(service=services_available.ADDRESS), logger)
