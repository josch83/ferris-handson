...
from magdemo_api.models.new_role_rights import NewRoleRights  # noqa: E501
from magdemo_api.models.role_rights import RoleRights  # noqa: E501
...
class TestRoleRightsController(BaseTestCase):
    ...
    def test_get_role_rightss(self):
        ...
        query_string = [('offset', 2),
                        ...
                        ('equal_entity', 'equal_entity_example'),
                        ('not_entity', 'not_entity_example'),
                        ('in_list_entity', 'in_list_entity_example'),
                        ('isnull_entity', true),
                        ('equal_id', 56),
                        ('not_id', 56),
                        ('in_list_id', 56),
