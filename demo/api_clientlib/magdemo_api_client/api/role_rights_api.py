...
class RoleRightsApi(object):
    ...
    def get_role_rightss(self, **kwargs):  # noqa: E501
        ...
        :param str equal_entity: Search for role_rightss, where entity == input
        :param str not_entity: Search for role_rightss, where entity != input
        :param list[str] in_list_entity: Search for role_rightss, where entity in input
    ...
    def get_role_rightss_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if 'equal_entity' in params:
            query_params.append(('equal_entity', params['equal_entity']))  # noqa: E501
        if 'not_entity' in params:
            query_params.append(('not_entity', params['not_entity']))  # noqa: E501
        if 'in_list_entity' in params:
            query_params.append(('in_list_entity', params['in_list_entity']))  # noqa: E501
            collection_formats['in_list_entity'] = 'multi'  # noqa: E501
